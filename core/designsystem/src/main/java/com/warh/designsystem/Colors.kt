...
object ColorTokens {
    object Light {
        ...
        val TertiaryContainer   = Color(0xFFBEF0E6)
        val OnTertiaryContainer = Color(0xFF0A2C26)
        ...
        val Background          = Color(0xFFFFF3F5)
        ...
        val InverseSurface      = Color(0xFF372E30)
        val InverseOnSurface    = Color(0xFFFBEDEF)
        val InversePrimary      = Color(0xFFFFB0B9)
    ...
    object Dark {
        val Primary             = Color(0xFF3A424E)
        val OnPrimary           = Color(0xFFDDE3EA)
        val PrimaryContainer    = Color(0xFF2C333D)
        val OnPrimaryContainer  = Color(0xFFDDE3EA)

        val Secondary            = Color(0xFF3A424E)
        val OnSecondary          = Color(0xFFE6EBF2)
        val SecondaryContainer   = Color(0xFF343C48)
        val OnSecondaryContainer = Color(0xFFD8DEE6)

        val Tertiary            = Color(0xFF3AA9A3)
        val OnTertiary          = Color(0xFF041F1E)
        val TertiaryContainer   = Color(0xFF1E3B39)
        val OnTertiaryContainer = Color(0xFFAEE7E2)
        ...
        val OnBackground        = Color(0xFFE2E6EE)
        ...
        val InverseSurface      = Color(0xFFE6EAF0)
        val InverseOnSurface    = Color(0xFF1A1F27)
        val InversePrimary      = Color(0xFF8BA2BF)
